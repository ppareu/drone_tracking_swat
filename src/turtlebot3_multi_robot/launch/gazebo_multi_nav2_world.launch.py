...
def generate_launch_description():
    ...
    robots = [
        # {'name': 'tb1', 'x_pose': '3.12', 'y_pose': '-1.31', 'z_pose': 0.01, 'initpose' : ['10.0', '0.55']},
        {'name': 'tb1', 'x_pose': '0.0', 'y_pose': '-1.0', 'z_pose': 0.01, 'initpose' : ['0.0', '-1.0'], 'model': 'burger'},
        {'name': 'tb2', 'x_pose': '3.0', 'y_pose': '13.0', 'z_pose': 0.01, 'initpose' : ['3.0', '13.0'], 'model': 'waffle'},
    ...
    for robot in robots:
        ...
        TURTLEBOT3_MODEL = robot['model'] # waffle / burger
    ...
    for robot in robots:
        ...
        message = '{header: {frame_id: map}, pose: {pose: {position: {x: ' + \
            robot['initpose'][0] + ', y: ' + robot['initpose'][1] + \
