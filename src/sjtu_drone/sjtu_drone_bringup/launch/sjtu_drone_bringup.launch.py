...
def generate_launch_description():
    ...
    drone_ctrl = DeclareLaunchArgument(
            "controller",
    ...
    drone_inc = IncludeLaunchDescription(
    ...
    drone_op = OpaqueFunction(
            function=get_teleop_controller,
            kwargs={'model_ns': model_ns},
        )

    ld.add_action(drone_ctrl)
    ld.add_action(drone_node)
    ld.add_action(drone_inc)
    ld.add_action(drone_joy)
    ld.add_action(drone_op)
    #===================================================== Drone    
